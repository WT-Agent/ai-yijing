    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">易经周易卦象解析</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 易经六爻周易占卜助手</span>
...
// 清理回复末尾的特殊标记 [YIJING_SCORES]...[/YIJING_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[YIJING_SCORES\][\s\S]*?\[\/YIJING_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 易经六爻周易占卜与人生智慧】\n\n${cleanContent.value}\n\n体验周易解卦AI助手：https://ai.wuxian.xyz`;
